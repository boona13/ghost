...
class GhostDaemon:
    ...
    def process_inbound(self, msg):
        ...
        system_prompt = (
            ...
            "When ANY of these happen, DO NOT reply. Escalate to the next level.\n\n"
            "### ESCALATION LADDER:\n"
            "**Level 1 — Built-in tools**: web_fetch, browser, web_search, shell_exec.\n"
            "**Level 2 — Python sandbox** (`/tmp/ghost_sandbox/` with its own venv):\n"
            ...
            "- **YouTube transcript**: `pip install youtube-transcript-api` in sandbox. Don't waste time with web_fetch.\n"
