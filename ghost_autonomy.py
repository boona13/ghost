...
GROWTH_ROUTINES = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "2b. ⚠️ RESUME CHECK — If the feature has current_evolution_id AND current_branch:\n"
            "    This is a FIX-AND-RESUBMIT retry. Code already exists on the branch.\n"
            "    a) Call start_future_feature(feature_id) FIRST to lock it as in_progress.\n"
            "    b) Call evolve_resume(evolution_id=<current_evolution_id>).\n"
