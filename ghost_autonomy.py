...
GROWTH_ROUTINES = [
    {
        ...
        "prompt": (
            ...
            "        * affected_files: The files that need to be created or modified.\n"
            "        * proposed_approach: What the implementation does, what pip packages\n"
            "          it needs. Be specific enough that the Evolution Runner can implement\n"
    ...
    },
    {
        ...
        "prompt": (
            ...
            "## ARCHITECTURE\n"
            "🔵 ISOLATED TOOLS (implementation_type=tool): Use tools_create(name, description, code, deps=[...]).\n"
            "   This is the PREFERRED path for new features. It writes ghost_tools/<name>/tool.py for you.\n"
            ...
            "🔵 CORE MODULE (implementation_type=core): Create ghost_<feature>.py with build_<feature>_tools(cfg).\n"
            "   Import in ghost.py and register. Only for deep system integration.\n"
            ...
            "🔴 CRITICAL: You MUST reach evolve_plan within 20 steps total.\n"
            "Do NOT spend more than 10 steps on research/exploration.\n"
            "If you are past step 15 and haven't called evolve_plan, STOP researching\n"
            "and call evolve_plan IMMEDIATELY with what you know.\n\n"
            ...
            "   🔴 STEP BUDGET: You have a MAXIMUM of 10 tool calls for exploration.\n"
            "   After 10 research calls, you MUST move to evolve_plan. No exceptions.\n"
            "   Do NOT curl external APIs, do NOT run shell scripts for research.\n"
            "   a) memory_search(query='<feature keywords>', type_filter='mistake')\n"
            "      — MANDATORY CALL. Check for known pitfalls. Read and apply lessons.\n"
            "   b) file_read the files you plan to patch or extend.\n"
            ...
            "   e) Check ghost_nodes/ for existing nodes that do something similar.\n\n"
            ...
            "- New feature = new ghost_<feature>.py module with build_<feature>_tools().\n"
            "  Import in ghost.py and register the tools. Bug fixes = patch existing core files.\n"
            "- Isolated LLM tools = use tools_create(name, description, code, deps=[...]) for ghost_tools/<name>/.\n"
            ...
            "  For features with implementation_type=tool, ALWAYS use tools_create. Do NOT use evolve_apply.\n"
    ...
    },
    {
        ...
        "prompt": (
            ...
            "   - affected_files: The files that need to be created or modified.\n"
            "   - proposed_approach: What the implementation does. What pip packages it needs.\n"
