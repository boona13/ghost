...
GROWTH_ROUTINES = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "   a) grep('relevant_pattern', include='*.py') to find existing related code.\n"
            "   b) file_read on the files you'll modify — understand the FULL context.\n"
            "   c) glob('ghost_*.py') to see all existing modules and avoid conflicts.\n"
            ...
            "    Step 9 MUST come before step 10.\n"
            "    If the PR is REJECTED or BLOCKED, the feature is marked failed/blocked\n"
            "    automatically. Just call task_complete after.\n\n"
            "## CODE STANDARDS\n"
    ...
    },
    {
        ...
        "prompt": (
            ...
            "2. Pick the 3 most recently implemented features (they appear first in the list).\n"
            "   For each, call get_future_feature(id) to get the full brief.\n"
            "3. SKIP these features (do NOT audit them):\n"
            "   a) Any feature that has 'audited_at' set — it was already audited. HARD SKIP.\n"
            "   b) Any feature whose title starts with 'Wiring fix:' — these are your OWN fixes.\n"
            "      Auditing your own fixes creates infinite fix-the-fix chains.\n"
            "   c) Any feature with source='implementation_auditor' — also your own output.\n"
