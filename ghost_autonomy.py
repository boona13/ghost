...
GROWTH_ROUTINES = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "## ARCHITECTURE\n"
            "New feature = new file. Create ghost_<feature>.py with a build_<feature>_tools(cfg)\n"
            "function. Import it in ghost.py and register the tools.\n"
            ...
            "- Isolated LLM tools = use tools_create(name, description, code) to create in ghost_tools/<name>/.\n"
