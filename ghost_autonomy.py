...
GROWTH_ROUTINES = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "6b. RE-READ DEPENDENCIES (critical — context may have been compacted):\n"
            "    Your file_read results from step 5 are likely TRIMMED by now.\n"
            "    Right before writing code, RE-READ every file you will import from:\n"
            ...
            "    This ensures the real API signatures are in your RECENT context\n"
            "    (last 20 messages are never trimmed). Do NOT skip this — it is the\n"
            "    #1 cause of hallucinated method calls.\n\n"
            ...
            "8. evolve_test(evolution_id) — if FAIL, fix with evolve_apply and re-test.\n"
