...
GROWTH_ROUTINES = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "    ⚠️ IF THE PR IS REJECTED: call task_complete IMMEDIATELY. Do NOT retry.\n"
            "    The feature is automatically re-queued with ALL reviewer feedback accumulated.\n"
            "    A FUTURE run will attempt it again with full context of every past rejection.\n"
