    ...
    api.register_tool({
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "duration": {"type": "integer", "description": "Duration in seconds (2-10). Default: 5."},
                "ratio": {
                    "type": "string",
    ...
    api.register_tool({
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "duration": {"type": "integer", "description": "Duration in seconds (2-10). Default: 5."},
                "model": {"type": "string", "description": "Model. Default: gen4_turbo.", "enum": RUNWAY_MODELS},
                "ratio": {"type": "string", "description": "Aspect ratio.", "enum": ["16:9", "9:16", "1:1", "4:3", "3:4", "21:9"]},
