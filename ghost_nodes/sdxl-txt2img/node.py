"""
sdxl-txt2img -- auto-generated from ComfyUI workflow.
SDXL text-to-image community workflow
"""
...
log = logging.getLogger("ghost.node.sdxl_txt2img")
...
def register(api):
        ...
        for fpath in saved:
            ...
            if p.exists():
                api.save_media(
                    ...
                    media_type="image",
                    metadata={"source_workflow": "sdxl-txt2img", "elapsed": round(elapsed, 2)},
                )
    ...
    api.register_tool({
        "name": "sdxl_txt2img",
        "description": "SDXL text-to-image community workflow Models: sd_xl_base_1.0.safetensors.",
        "parameters": {
            "type": "object",
            "properties": {"prompt": {"type": "string", "description": "Text prompt (default: a beautiful sunset over mountains, golden hour, dr)"}, "prompt_2": {"type": "string", "description": "Text prompt (default: ugly, blurry, low quality, distorted)"}, "seed": {"type": "number", "description": "seed (default: 42)"}, "steps": {"type": "number", "description": "steps (default: 25)"}, "cfg": {"type": "number", "description": "cfg (default: 7.0)"}, "denoise": {"type": "number", "description": "denoise (default: 1.0)"}},
            "required": [],
        },
        "execute": execute,
    })
