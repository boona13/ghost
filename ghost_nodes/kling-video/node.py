    ...
    api.register_tool({
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "cfg_scale": {"type": "number", "description": "CFG guidance scale 0.0-1.0. Higher = more prompt adherence. Default: 0.5."},
                "camera_control": {
                    "type": "string",
                ...
                "generate_audio": {"type": "boolean", "description": "Generate native audio with the video. Default: true (V3 default)."},
                "shot_type": {
                    "type": "string",
    ...
    api.register_tool({
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "cfg_scale": {"type": "number", "description": "CFG guidance scale 0.0-1.0. Default: 0.5."},
                "generate_audio": {"type": "boolean", "description": "Generate native audio. Default: true."},
            },
            "required": ["image_path"],
        },
