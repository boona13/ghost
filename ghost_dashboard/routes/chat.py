...
def _process_message(session, daemon):
    ...
    try:
        ...
        system_prompt = (
            ...
            "When ANY of these happen, DO NOT reply to the user. Escalate to the next level instead.\n\n"
            "### ESCALATION LADDER (follow IN ORDER until the task is done):\n"
            "**Level 1 — Built-in tools**: web_fetch, browser, web_search, shell_exec.\n"
            "**Level 2 — Python sandbox**: Write and run a script in `/tmp/ghost_sandbox/`:\n"
            ...
            "- **YouTube transcript**: `pip install youtube-transcript-api` in sandbox, then "
            "`YouTubeTranscriptApi.get_transcript(video_id)`. Do NOT waste time with web_fetch on YouTube.\n"
            ...
            "the working script from /tmp/ghost_sandbox/, and the pip deps>', "
