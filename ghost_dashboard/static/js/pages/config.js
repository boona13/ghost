    ...
    <div class="cfg-tab-panel" data-panel="features">
      <div class="stat-card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8">
          ${['enable_tool_loop','enable_memory_db','enable_plugins','enable_skills','enable_system_tools','enable_browser_tools','enable_browser_use','enable_channels','enable_cron','enable_evolve','enable_future_features','enable_extensions','enable_integrations','enable_web_search','enable_web_fetch','enable_image_gen','enable_vision','enable_tts','enable_canvas','enable_security_audit','enable_session_memory','enable_mcp','enable_langfuse'].map(k => toggle(k)).join('')}
        </div>
      </div>
