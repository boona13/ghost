...
import { render as subagents } from './pages/subagents.js';
import { render as langfuse } from './pages/langfuse.js';
import { render as browser_use } from './pages/browser_use.js';
const pages = { overview, chat, models, config, soul, user, skills, cron, memory, feed, evolve, integrations, autonomy, accounts, setup, security, console: console_page, channels, future_features, webhooks, projects, prs, mcp, subagents, langfuse, browser_use };
